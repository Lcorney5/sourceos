...
export const PLAN_LIMITS: Record<
  WorkspacePlan,
  { suppliers: number | null; members: number | null; products: number | null }
> = {
  starter: { suppliers: 25, members: 5, products: 3 },
  growth: { suppliers: 100, members: 15, products: null },
  agency: { suppliers: null, members: null, products: null },
};
